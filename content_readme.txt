...
power, factorial, Fibonacci with request/response logging to an SQLite database. The API utilize Pydantic
models, supports in memory caching, and provides an interactive Swagger UI. The program was developed using MVCS principles.
...
The models(mth_service/models/): contaitns request_log_model.py that handles database tables initialization and provide the log_to_db
